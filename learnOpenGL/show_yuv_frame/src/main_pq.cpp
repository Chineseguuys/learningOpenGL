...
static const std::string yuv_file_path = "../res/yuv/hdr_3840x2160_pq_yuv420p10le.yuv";
...
int main(int argc, char* argv[]) {
    ...
    Shader shader{"../res/glsl/show_yuv_frame_pq.vs", "../res/glsl/show_yuv_frame_pq.fs"};
    shader.use();
