...
int main(int argc, char *argv[])
{
    ...
    // 以逆时针的方向来渲染三角形
    // GL_CW： 以顺时针的顺序来渲染三角形
    // GL_CCW: 以逆时针的顺序来渲染三角形
    glFrontFace(GL_CCW);

    Shader shader{"../resources/glsl/blinging.vs", "../resources/glsl/blinging.fs"};
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // sorted the transparent windows before rendering
