...
{
    glUniform2fv(getLocalUniform(name), 1, &value[0]);
}

void Shader::setVec2(const std::string &name, float x, float y)
{
    glUniform2f(getLocalUniform(name), x, y);
}

void Shader::setVec3(const std::string &name, const glm::vec3& value)
{
    glUniform3fv(getLocalUniform(name), 1, &value[0]);
}

void Shader::setVec3(const std::string &name, float x, float y, float z)
{
    glUniform3f(getLocalUniform(name), x, y, z);
}

void Shader::setVec4(const std::string &name, const glm::vec4& value)
{
    glUniform4fv(getLocalUniform(name), 1, &value[0]);
}

void Shader::setVec4(const std::string &name, float x, float y, float z, float w)
{
    glUniform4f(getLocalUniform(name), x, y, z, w);
}
