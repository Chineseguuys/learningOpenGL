...
static const char *VERTEX_FILE = "../resources/glsl/model_loading.vs";
static const char *FRAGMENT_FILE = "../resources/glsl/model_loading.fs";
...
int main(int argc, char *argv[]) {
    ...
    // 在窗口中捕获鼠标，将不在显示鼠标的位置[有一些 bug, 在调试的时候，会导致整个窗口无法进行操控，先暂时关闭]
